...
if ($row ['diagnosis_check'] == 1) {
	...
	while ( $n <= $count_no ['num'] ) {
		$first ++;
		if (($first == 1) && (($row ['diagnosis_1'] > 0) || ($row ['diagnosis_2'] > 0) || ($row ['diagnosis_3'] > 0) || ($row ['diagnosis_4'] > 0) || ($row ['diagnosis_5'] > 0) || ($row ['diagnosis_6'] > 0) || ($row ['diagnosis_7'] > 0) || ($row ['diagnosis_8'] > 0) || ($row ['diagnosis_9'] > 0) || ($row ['diagnosis_10'] > 0))) {
			echo "<br/>";
...
if ($row ['diag_me_check'] == 1) {
	...
	while ( $n <= $count_no ['num'] ) {
		$first ++;
		if (($first == 1) && (($row ['diag_me_1'] > 0) || ($row ['diag_me_2'] > 0) || ($row ['diag_me_3'] > 0) || ($row ['diag_me_4'] > 0) || ($row ['diag_me_5'] > 0) || ($row ['diag_me_6'] > 0) || ($row ['diag_me_7'] > 0) || ($row ['diag_me_8'] > 0) || ($row ['diag_me_9'] > 0) || ($row ['diagnosis_10'] > 0))) {
			echo "<br/>";
...
<center>
	<input type="submit" value="Assessment"
		...
		onclick="window.location='/searchdata.php';" /> <input type="button"
