...
write_menu();
	...
	<head>
		<title>
		 Client Contact Submission Form
		</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta name="description" content="Client Contact Submission">
			...
			<body onload="clearForm()">
				<div id="top">
					...
					<?php echo $_SESSION['logo'] ?>
						...
						<div id="header">
							<div id="title">
							<center><h1>Client Contact Submission Form</h1></center>
							</div><!-- div title end -->
                		</div><!-- close div header -->
            	</div><!--close div top -->
					<div id="clinic_id">
				<br><center><p>Please enter the clinic identification code and then submit.</p></center>
				<form id="form1" name="form1" action="insertContact.php" method="post">
