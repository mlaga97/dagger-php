...
<html>
	<head>
		<title>Survey Submission Form</title>
					...
					<center>
						<table id="clinic_id" border="1">
							<tr>
								...
								<td class="n"><center>9</center></td>
							</tr>

							<tr>
								<td class="n"><center>Digit 1:</center></td>
							...
							<tr>
								<td class="n"><center>Digit 2:</center></td>
							...
							<tr>
								<td class="n"><center>Digit 3:</center></td>
							...
							<tr>
								<td class="n"><center>Digit 4:</center></td>
