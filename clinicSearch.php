	...
	<body onload="clearForm();">
		...
		<div id="container">
			...
			<form id="form1" method="post" action="">
				<br><br>
				<b>You are logged in as an administrator.</b>
				<br><br>
				<?php
				...
				<p>Starting Date: <input type="text" name = "start_date" id="start_date" />   Ending Date: <input type="text" name = "end_date" id="end_date" /></p>
				...
				<br/>
				<button type="submit" action="/clinicSearch.php" method="post" style="height: 25px; width: 150px">Search Clinic Data</button>
				<br/><br/><br/>
			</form>
