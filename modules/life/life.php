...
function life_scoring($copy, $mysqli){
    ...
    if ((array_key_exists('life_1', $copy) && $copy['life_1'] ==1)||($copy['life_2'] ==1)||($copy['life_3'] ==1)){ //if there was a positive response to any of the yes/no questions
            echo "<div>As documented in the Life Attitudes Schedule, note the following issues:</div>";
            echo "<span style=\"color:red\">";
        if (array_key_exists('life_1', $copy) && $copy['life_1'] ==1){
