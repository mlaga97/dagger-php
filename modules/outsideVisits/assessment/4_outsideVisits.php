<div id="questions" <?php if ($_SESSION['grouping']== 10) echo 'style="display: none;"'; ?>>
	...
	<INPUT TYPE="radio"  id="q1_1" NAME="q1" VALUE="yes" onclick="document.getElementById('q1_fu').style.display = 'block';">Yes
	<INPUT TYPE="radio"  id="q1_2" NAME="q1" VALUE="no"  onclick="document.getElementById('q1_fu').style.display = 'none';">No</p>
	...
	<INPUT TYPE="radio" id= "q2_1" NAME="q2" VALUE="yes" onclick="document.getElementById('q2_fu').style.display = 'block';">Yes
	<INPUT TYPE="radio" id= "q2_2" NAME="q2"  VALUE="no"  onclick="document.getElementById('q2_fu').style.display = 'none';">No</p>
	<div id="q2_fu" style="display:none;">
		<p>
			<strong>Date of ER visit:</strong>
			<input type="date"  name="er_visit_date" id="er_visit_date" placeholder=""> (format: YYYY/MM/DD)
		</p>
		<p>
			<strong>Reason for ER visit:</strong>
	...
	<INPUT TYPE="radio" id= "q3_1" NAME="q3" VALUE="yes" onclick="document.getElementById('q3_fu').style.display = 'block';">Yes
	<INPUT TYPE="radio" id="q3_2"  NAME="q3"  VALUE="no"  onclick="document.getElementById('q3_fu').style.display = 'none';">No</p>
	<div id="q3_fu" style="display:none;">
		<p>
			<strong>Date of office visit:</strong>
			<input type="date"  name="office_visit_date" id="office_visit_date" placeholder=""> (format: YYYY/MM/DD)
		</p>
		<p>
			<strong>Reason for office visit:</strong>
