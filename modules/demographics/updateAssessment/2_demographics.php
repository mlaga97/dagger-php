	...
	<tr>
		...
		<td>
			<table border="1" align="center" id="table_sex">
				...
				<tr>
					<td class="sf">Male</td><td class="demo_input"><center><input type="radio" name="sex"value="male"/></center></td>
					<td class="sf">Female</td><td class="demo_input"><center><input type="radio" name="sex"value="female"/></center></td>
				</tr>
				<tr>
					<td class="sf">Transgender</td><td class="demo_input"><center><input type="radio" name="sex"value="transgender"/></center></td>
					<td class="sf">Other</td><td class="demo_input"><center><input type="radio" name="sex"value="other"/></center></td>
				</tr>
			</table>
		</td>
		...
		<?php if($_SESSION['assessment_type'] == 'Adult') { ?>
				<td>
					<table border="1" align="center" id="table_marital">
						...
						<tr>
							<td class="ms">Single.</td><td class="demo_input"><center><input type="radio" name="m_status"value="single"/></center></td>
							<td class="ms">Married.</td><td class="demo_input"><center><input type="radio" name="m_status"value="married"/></center></td>
						</tr>
						<tr>
							<td class="ms">Divorced.</td><td class="demo_input"><center><input type="radio" name="m_status"value="divorced"/></center></td>
							<td class="ms">Widow(ed).</td><td class="demo_input"><center><input type="radio" name="m_status"value="widow(ed)"/></center></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<table border="1" id="table_education">
			<?php if($_SESSION['assessment_type'] == 'Adult') { ?><tr><td colspan="2">
				...
				<tr>
					...
					<td class="demo_input">
						<center><input type="radio" name="ed"value="Elementary/Jr. high school"/></center>
					</td>
					<td class="ed">2-year degree.</td>
					<td class="demo_input">
						<center><input type="radio" name="ed"value="2-year degree"/></center>
					</td>
				</tr>
				<tr>
					<td class="ed">Some high school.</td><td class="demo_input"><center><input type="radio" name="ed"value="Some high school"/></center></td>
					<td class="ed">4-year degree.</td><td class="demo_input"><center><input type="radio" name="ed"value="4-year degree"/></center></td>
				</tr>
				<tr>
					<td class="ed">High school diploma or GED.</td><td class="demo_input"><center><input type="radio" name="ed"value="High school diploma or GED"/></center></td>
					<td class="ed">More than 4 years college.</td><td class="demo_input"><center><input type="radio" name="ed"value="More than 4 years college"/></center></td>
				</tr>
				<tr>
					<td class="ed">Some college.</td><td class="demo_input"><center><input type="radio" name="ed"value="Some college"/></center></td>
			...
			<?php } else { ?>
				...
				<tr>
					<td class="c_ed" align="right">1</td><td class="demo_input"><center><input type="radio" name="ed" value="1"/></center></td>
					...
					<td class="c_ed" align="right">12</td><td class="demo_input"><center><input type="radio" name="ed" value="12"/></center></td>
				</tr>
			<?php } ?>
		</table>
		</td></tr>
				...
				<td colspan="2">
					<table border="1" id="table_birth_order">
						...
						<tr>
							...
							<td class="demo_input">
								<center><input type="radio" name="c_bo"value="Oldest"/></center>
							</td>
							<td class="bo">Youngest. </td>
							<td class="demo_input">
								<center><input type="radio" name="c_bo"value="Youngest"/></center>
							</td>
							<td class="bo">Middle. </td>
							<td class="demo_input">
								<center><input type="radio" name="c_bo"value="Middle"/></center>
							</td>
							<td class="bo">Twin. </td>
							<td class="demo_input">
								<center><input type="radio" name="c_bo"value="Twin"/></center>
							</td>
						</tr>
					</table>
				</td>
