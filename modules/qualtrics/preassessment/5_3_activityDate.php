...
<label><input type="radio" name="activityDateCheck" checked="checked" onclick="document.getElementById('edu.usm.dagger.module.qualtrics.activityDate_selection').style.display = 'none';"/>Yes</label>
