...
<html>
	<head>
		...
		<script type="text/javascript" src="/modules/jsonAssessment/assessment.js"></script>
		<script type="text/javascript" src="/modules/jsonAssessment/jsonAssessment.js"></script>
		<script type="text/javascript" src="/modules/jsonAssessmentClasses/questionClasses.js"></script>
	</head>
	<body>
		<div class='container'>
			...
			<!-- Body -->
			<form id='assessment_form' action='/reviewAssessment.php' method='post' autocomplete='off' >
			</form>
