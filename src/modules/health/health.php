...
function score_chronic_health($a) {
	...
	if (($a ['valueA1C'] !== "NA") || ($a ['A1CDate'] !== "") || ($a ['valueEAG'] !== "NA") || ($a ['eAGDate'] !== "") || ($a ['valueLDL'] !== "NA") || ($a ['valueHDL'] !== "NA") || ($a ['cholestoralDate'] !== "") || ($a ['valueSYS'] !== "NA") || ($a ['valueDIA'] !== "NA") || ($a ['bpDate'] !== "") || ($a ['valueHeight'] !== "NA") || ($a ['valueWeight'] !== "NA") || ($a ['physicalDate'] !== "")) {
